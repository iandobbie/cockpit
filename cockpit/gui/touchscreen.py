        ...
        sizer_grid.AddMany(
            (
                (
                    IconButton(
                        self,
                        "touchscreen/raster/action_mosaic.png",
                        lambda e: self._cb_mosaic(e),
                        toggleable=True,
                        icon_pressed="touchscreen/raster/action_mosaic.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/action_centre.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/action_erase.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/action_experiment.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/action_marker.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/action_snap.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/action_live.png",
                        lambda e: self._cb_live(e),
                        toggleable=True,
                        helptext="Start or stop continuous image capture with all active cameras.",
                    ),
                    wx.GBPosition(1, 1),
                    wx.GBSpan(1, 1),
                    wx.ALIGN_CENTER,
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/action_help.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/action_abort.png",
...
class VariableControlContinuous(wx.Panel):
    ...
    def _do_layout(self):
        ...
        img_minus = wx.Image(
            os.path.join(
                cockpit.gui.IMAGES_PATH, "touchscreen/raster/misc_minus.png"
            )
        )
        ...
        img_plus = wx.Image(
            os.path.join(
                cockpit.gui.IMAGES_PATH, "touchscreen/raster/misc_plus.png"
            )
        )
    ...
    def _step(self, direction):
        ...
        new_value = (
            self._value * pow(self._step_scale, sign) + sign * self._step_offset
        )
    ...
    def _do_layout(self):
        ...
        img = wx.Image(
            os.path.join(
                ...
                "touchscreen/raster/misc_wavelength.png",
            )
        )
        if self.power:
            img.Replace(
        ...
        exposure_img = wx.Image(
            os.path.join(
                cockpit.gui.IMAGES_PATH, "touchscreen/raster/misc_pulse.png"
            )
        )
        ...
        if self.power:
            ...
            power_img = wx.Image(
                os.path.join(
                    cockpit.gui.IMAGES_PATH, "touchscreen/raster/misc_power.png"
                )
            )
...
class CamerasPanelEntry(wx.Panel):
    ...
    def _do_layout(self):
        ...
        if "gain" in self.camera.settings:
            ...
            gain_img = wx.Image(
                os.path.join(
                    cockpit.gui.IMAGES_PATH, "touchscreen/raster/misc_opamp.png"
                )
            )
...
class StageControlXY(wx.Panel):
    ...
    def _do_layout(self):
        ...
        # TODO: Use cockpit.interfaces.stageMover.changeStepSize but modify it
        ...
        sizer_buttons.AddMany(
            (
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_move_left.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_move_up.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_move_down.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_move_right.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_tiles.png",
...
class StageControlZ(wx.Panel):
        ...
        sizer_buttons.AddMany(
            (
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_save_top.png",
                        lambda e: self._cb_save_top(e),
                        helptext="Save the current position as the top soft limit.",
                    ),
                    wx.ALIGN_CENTER,
                ),
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_move_top.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_move_centre.png",
                        lambda e: self._cb_move_centre(e),
                        helptext="Move to the centre of the top and bottom soft limits.",
                    ),
                    wx.ALIGN_CENTER,
                ),
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_recentre.png",
                        lambda e: self._cb_recentre(e),
                        helptext="Recentre all fine stages and then move the course stage so that the focus plane remains the same.",
                    ),
                    wx.ALIGN_CENTER,
                ),
                (
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_save_bottom.png",
                        lambda e: self._cb_save_bottom(e),
                        helptext="Save the current position as the bottom soft limit.",
                    ),
                    wx.ALIGN_CENTER,
                ),
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_move_bottom.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_touchdown.png",
                        lambda e: self._cb_touchdown(e),
                        helptext="Move to the specimen position, as defined in the configuration file.",
                    ),
                    wx.ALIGN_CENTER,
                ),
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_switch.png",
    ...
    def _cb_move_top(self, e):
        cockpit.interfaces.stageMover.moveZCheckMoverLimits(
            cockpit.interfaces.stageMover.mover.SavedTop
        )
        ...
        sizer.AddMany(
            (
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_safeties.png",
                ...
                (
                    IconButton(
                        self,
                        "touchscreen/raster/stage_move.png",
...
class ImagePreviewPanel(wx.lib.scrolledpanel.ScrolledPanel):
    ...
    def resetGrid(self):
        ...
        ):  # avoid this path during initialisation when the client size is still 1x1
    ...
    def _do_layout(self):
        ...
        for axis_index, axis_label in enumerate(("X", "Y", "Z")):
            for limit_index, limit_label in enumerate(("min", "max")):
                # Boundaries
                limits_hard = (
                    cockpit.interfaces.stageMover.getHardLimitsForAxis(
                        axis_index
                    )
                )
                limits_soft = (
                    cockpit.interfaces.stageMover.getSoftLimitsForAxis(
                        axis_index
                    )
                )
                # Widgets
